...
TEST(array_swap, case1) {
  s21::array<int, 4> s21_arr_ref_int{21, 21, 21, 21};
  s21::array<int, 4> s21_arr_res_int{1, 1, 1, 1};
  ...
  EXPECT_EQ(s21_arr_ref_int[3], 1);
  EXPECT_EQ(s21_arr_res_int[0], 21);
  EXPECT_EQ(s21_arr_res_int[1], 21);
  EXPECT_EQ(s21_arr_res_int[2], 21);
  EXPECT_EQ(s21_arr_res_int[3], 21);
